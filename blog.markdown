...
* **Ability to fit complex data.** There are many natural data distributions for which we know approximations by neural networks, but not by any other function approximation method.
